...
XXXXXXX ,  KC_COMMA ,  KC_7 ,  KC_8    ,  KC_9    ,  KC_0     ,    KC_0     ,  KC_9    ,  KC_8    ,  KC_7 ,  KC_COMMA ,  XXXXXXX ,
XXXXXXX ,  KC_DOT   ,  KC_4 ,  KC_5    ,  KC_6    ,  KC_COLON ,    KC_COLON ,  KC_6    ,  KC_5    ,  KC_4 ,  KC_DOT   ,  XXXXXXX ,
XXXXXXX ,  KC_EQL   ,  KC_1 ,  KC_2    ,  KC_3    ,  KC_MINS  ,    KC_MINS  ,  KC_3    ,  KC_2    ,  KC_1 ,  KC_EQL   ,  XXXXXXX ,
                               KC_TRNS ,  KC_TRNS ,  KC_TRNS  ,    KC_TRNS  ,  KC_TRNS ,  KC_TRNS
        ),
        [_NUMPAD] = LAYOUT_split_3x6_3(
XXXXXXX ,  KC_COMMA ,  KC_7 ,  KC_8    ,  KC_9    ,  KC_0     ,    KC_BSPC  ,  KC_TAB   ,  C(KC_N) ,  C(KC_P) ,  KC_SPC      , XXXXXXX ,
XXXXXXX ,  KC_DOT   ,  KC_4 ,  KC_5    ,  KC_6    ,  KC_COLON ,    KC_LEFT  ,  KC_DOWN  ,  KC_UP   ,  KC_RGHT ,  KC_ENT      , XXXXXXX ,
XXXXXXX ,  KC_EQL   ,  KC_1 ,  KC_2    ,  KC_3    ,  KC_MINS  ,    KC_PGUP  ,  KC_PGDN  ,  KC_HOME ,  KC_END  ,  KC_NUM_LOCK , XXXXXXX ,
                               KC_TRNS ,  KC_TRNS ,  KC_TRNS  ,    KC_TRNS  ,  KC_TRNS  ,  KC_TRNS
        ),
        [_MEDIA] = LAYOUT_split_3x6_3(
XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  KC_MUTE ,  KC_MPRV ,  KC_MPLY ,  KC_MNXT ,  KC_BRIU , XXXXXXX ,
XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  KC_VOLD ,  KC_VOLU ,  XXXXXXX ,  XXXXXXX ,  KC_BRID , XXXXXXX ,
XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX , XXXXXXX ,
                                 KC_TRNS ,  KC_TRNS ,  KC_TRNS ,  KC_TRNS ,  KC_TRNS ,  KC_TRNS
        ),
        [_VIMMUX] = LAYOUT_split_3x6_3(
XXXXXXX ,  VIM_CQALL , VIM_SAVE ,  VIM_SPEC ,  VIM_TEMP ,  VIM_TABI ,    TMUX_MODE ,  TMUX_PS   ,  TMUX_NS   ,  TMUX_OZ ,  TMUX_PASTE , XXXXXXX ,
XXXXXXX ,  VIM_TABF  , VIM_TABP ,  VIM_TABN ,  VIM_TABL ,  VIM_TABR ,    TMUX_SW   ,  TMUX_PP   ,  TMUX_PW   ,  TMUX_NW ,  TMUX_NP    , XXXXXXX ,
XXXXXXX ,  VIM_WQALL , VIM_MISC ,  VIM_FUNC ,  VIM_NAV  ,  VIM_ZOOM ,    TMUX_IDX  ,  TMUX_ZOOM ,  TMUX_FUNC ,  TMUX_VP ,  TMUX_COPY  , XXXXXXX ,
                                   KC_TRNS  ,  KC_TRNS  ,  KC_TRNS  ,    KC_TRNS   ,  KC_TRNS   ,  KC_TRNS
        ),
        // tri-state layer; do not switch to directly
        [_ADJUST] = LAYOUT_split_3x6_3(
XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  ZOOM_TOG ,  SS_WIN  ,  WARPD_L ,    XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX , XXXXXXX ,
XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  SS2C     ,  SS      ,  XXXXXXX ,    XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX , XXXXXXX ,
XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  SSS2C    ,  SSS     ,  XXXXXXX ,    XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX ,  XXXXXXX , XXXXXXX ,
                                 KC_TRNS  ,  KC_TRNS ,  KC_TRNS ,    KC_TRNS ,  KC_TRNS ,  KC_TRNS
        ),
        [_DISCORD] = LAYOUT_split_3x6_3(
XXXXXXX ,  ACT_LEFT ,  KC_TAB  ,  KC_UP   ,  KC_PLUS  ,  DIS_SECT_NAV ,      XXXXXXX      ,  DIS_PREV_SERV ,  DIS_NEXT_SERV ,  DIS_PINS      ,  ACT_RIGHT     , XXXXXXX ,
...
XXXXXXX ,  ACT_LEFT ,  MS_BTN2 ,  MS_UP   ,  MS_BTN1 ,  MS_WHLU  ,    MS_WHLU  ,  MS_BTN1 ,  MS_UP   ,  MS_BTN2 ,  ACT_RIGHT , XXXXXXX ,
XXXXXXX ,  MS_ACL0  ,  MS_LEFT ,  MS_DOWN ,  MS_RGHT ,  MS_WHLD  ,    MS_WHLD  ,  MS_LEFT ,  MS_DOWN ,  MS_RGHT ,  MS_ACL1   , XXXXXXX ,
XXXXXXX ,  WARPD_L  ,  WARPD_T ,  WARPD_R ,  MS_BTN1 ,  MS_BTN2  ,    MS_BTN2  ,  MS_BTN1 ,  WARPD_L ,  WARPD_T ,  WARPD_R   , XXXXXXX ,
                                  KC_TRNS ,  KC_TRNS ,  MODE_OFF ,    MODE_OFF ,  KC_TRNS ,  KC_TRNS
        ),
