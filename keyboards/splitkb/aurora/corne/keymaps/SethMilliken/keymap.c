...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT_split_3x6_3(
     ...
     XXXXXXX ,  LCTL_T(KC_A)       ,  LGUI_T(KC_S) ,  LALT_T(KC_D)   ,  LSFT_T(KC_F)      ,  KC_G                ,    KC_H              ,  RSFT_T(KC_J)       ,  LALT_T(KC_K)     ,  RGUI_T(KC_L) ,  RCTL_T(KC_SCLN)     , XXXXXXX ,
	...
	[_MEDIA] = LAYOUT_split_3x6_3(
     XXXXXXX ,  KC_F1   ,  KC_F2   ,  KC_F3   ,  KC_F4   ,  KC_F5   ,  KC_MUTE ,  KC_MPRV ,  KC_MPLY ,  KC_MNXT ,  KC_BRID , XXXXXXX ,  
     XXXXXXX ,  KC_F6   ,  KC_F7   ,  KC_F8   ,  KC_F9   ,  KC_F10  ,  KC_VOLD ,  KC_VOLU ,  XXXXXXX ,  XXXXXXX ,  KC_BRIU , XXXXXXX ,
	...
	[_DISCORD] = LAYOUT_split_3x6_3(
     XXXXXXX ,  XXXXXXX ,  KC_TAB  ,  KC_UP   ,  KC_PLUS  ,  XXXXXXX   ,      TO(_DISCORD) ,  C(A(KC_UP))   ,  C(A(KC_DOWN)) ,  C(KC_P) ,  C(S(KC_N))     , XXXXXXX ,
     XXXXXXX ,  XXXXXXX ,  KC_LEFT ,  KC_DOWN ,  KC_RIGHT ,  XXXXXXX   ,      KC_PGDN      ,  A(S(KC_DOWN)) ,  A(S(KC_UP))   ,  KC_PGUP ,  KC_PGDN        , XXXXXXX ,
     XXXXXXX ,  XXXXXXX ,  KC_HOME ,  KC_ESC  ,  KC_END   ,  XXXXXXX   ,      KC_PGUP      ,  A(KC_LEFT)    ,  A(KC_RIGHT)   ,  XXXXXXX ,  C(A(S(KC_UP))) , XXXXXXX ,
                                      KC_TRNS ,  KC_TRNS  ,  TO(_BASE) ,      TO(_BASE)    ,  KC_TRNS       ,  KC_TRNS
        ),
