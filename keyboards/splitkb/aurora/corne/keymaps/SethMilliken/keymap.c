...
XXXXXXX ,  XXXXXXX ,  KC_TAB  ,  KC_UP   ,  KC_PLUS  ,  XXXXXXX   ,      DF(_DISCORD) ,  DIS_PREV_SERV ,  DIS_NEXT_SERV ,  DIS_PINS   ,  C(S(KC_N)) , XXXXXXX ,
XXXXXXX ,  XXXXXXX ,  KC_LEFT ,  KC_DOWN ,  KC_RIGHT ,  XXXXXXX   ,      KC_PGDN      ,  DIS_NEXT      ,  DIS_PREV      ,  KC_PGUP    ,  KC_PGDN    , XXXXXXX ,
